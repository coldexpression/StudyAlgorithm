...
public class problem2143 {
    public static void main(String[] args) throws IOException {
        ...
        for (int[] ints : aList) System.out.println(Arrays.toString(ints));
        ...
        System.out.println("===================");
        for (int[] ints : bList) System.out.println(Arrays.toString(ints));
        ...
        for(int i=0;i<aList.size();i++) {
            ...
            int middle = -1;
            System.out.println("==================");
            System.out.println(Arrays.toString(frInfo));
            while(true) {
